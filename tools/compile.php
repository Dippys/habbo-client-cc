<?php 
exec('C:\flex\bin\mxmlc.exe "' . __DIR__ . '\..\src\Habbo.as" -static-link-runtime-shared-libraries=true -swf-version=14 -default-background-color=#000000 -use-network=true -default-frame-rate 40 -default-size 1280 800');
