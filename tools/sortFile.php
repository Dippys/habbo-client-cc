...
foreach ($paths as $path => $data) {
    ...
    if (strpos($data, "import com.sulake.core.communication.messages.MessageEvent;") !== false) {
        ...
        forceFilePutContents(__DIR__ . "/../sort.com.sulake.habbo.communication.messages.incoming.".$fileName, $data);
        $deleteFile[] = $path;
    ...
    if (strpos($data, "import com.sulake.core.communication.messages.IMessageComposer;") !== false) {
        ...
        forceFilePutContents(__DIR__ . "/../sort.com.sulake.habbo.communication.messages.outgoing.".$fileName, $data);
        $deleteFile[] = $path;
...
file_put_contents(__DIR__ . "/../sort.txt", $tmp);
