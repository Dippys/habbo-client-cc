package com.sulake.habbo.ui.handler
{
    ...
    public class InfoStandWidgetHandler implements IRoomWidgetHandler 
    {
        ...
        public function processWidgetMessage(k:RoomWidgetMessage):RoomWidgetUpdateEvent
        {
            ...
            switch (k.type)
            {
                ...
                case RoomWidgetUserActionMessage.RWUAM_REPORT:
                    ...
                    this._container.habboHelp.reportUser(_local_2, -1, null);
                    break;
                case RoomWidgetUserActionMessage.RWUAM_REPORT_CFH_OTHER:
                    this._container.habboHelp.reportUser(_local_2, 124, null);
                    break;
        ...
        private function handleGetObjectInfoMessage(k:RoomWidgetRoomObjectMessage):RoomWidgetUpdateEvent
        {
            var _local_3:RoomUserData;
        ...
        private function handleGetBotInfoMessage(k:int, _arg_2:int, _arg_3:int, _arg_4:RoomUserData):void
        {
            ...
            _local_6.amIOwner = this._container.roomSession.isRoomOwner;
            ...
            _local_6.canBeKicked = this._container.roomSession.isRoomOwner;
        ...
        private function handleGetRentableBotInfoMessage(k:int, _arg_2:int, _arg_3:int, _arg_4:RoomUserData):void
        {
            ...
            _local_5.amIOwner = this._container.roomSession.isRoomOwner;
        ...
        private function handleGetUserInfoMessage(k:int, _arg_2:int, _arg_3:int, _arg_4:RoomUserData):void
        {
            ...
            _local_6.myRoomControllerLevel = this._container.roomSession.roomControllerLevel;
            _local_6.amIAnyRoomController = this._container.sessionDataManager.isAnyRoomController;
            _local_6.amIAnAmbassador = this._container.sessionDataManager.isAmbassador;
        ...
        private function onPetInfo(k:RoomSessionPetInfoUpdateEvent):void
        {
            ...
            if (((!(this._container == null)) && (!(this._container.events == null))))
            {
                ...
                _local_11.petRespectLeft = this._container.sessionDataManager.petRespectLeft;
                ...
                {
                    if ((((_local_12.isRoomOwner) || (this._container.sessionDataManager.isAnyRoomController)) || (_local_12.roomControllerLevel >= RoomControllerLevel.GUEST)))
                    {
                        _local_11._Str_5114 = true;
                    }
                }
        ...
        private function onPetFigureUpdate(k:RoomSessionPetFigureUpdateEvent):void
        {
        ...
        private function onConfirmPetBreedingEvent(k:RoomSessionConfirmPetBreedingEvent):void
        {
        ...
        private function onPetCommands(k:RoomSessionPetCommandsUpdateEvent):void
        {
