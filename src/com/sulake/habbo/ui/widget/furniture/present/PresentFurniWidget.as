package com.sulake.habbo.ui.widget.furniture.present
{
    ...
    public class PresentFurniWidget extends RoomWidgetBase implements IAvatarImageListener
    {
        ...
        public function _Str_5337(k:IFurnitureItem):Boolean
        {
            ...
            if ((((k.category == FurniCategory.FLOOR) || (k.category == FurniCategory.WALL_PAPER)) || (k.category == FurniCategory.LANDSCAPE)))
            {
                _local_2 = false;
            }
            else
            ...
            if (((this._placedItemId > 0) && (this._placedInRoom)))
            {
                ...
                if (this._placedItemType == ProductTypeEnum.PET)
                {
                    ...
                    while (_local_3 < _local_2)
                    {
                        ...
                        {
                            this._roomEngine.selectRoomObject(k, _local_5.roomObjectId, RoomObjectCategoryEnum.OBJECT_CATEGORY_USER);
                            break;
                        }
                        _local_3++;
                    }
                ...
                {
                    this._roomEngine.selectRoomObject(k, this._placedItemId, RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
                }
            }
        }
    }
