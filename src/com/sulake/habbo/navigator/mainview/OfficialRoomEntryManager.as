package com.sulake.habbo.navigator.mainview
{
    ...
    public class OfficialRoomEntryManager implements IDisposable 
    {
        ...
        private function _Str_24128(k:IWindowContainer, _arg_2:OfficialRoomEntryData, _arg_3:IBitmapWrapperWindow):void
        {
            ...
            _local_8 = new OfficialRoomImageLoader(this._navigator, _local_6, _arg_3, _local_4, "image/png", 64, 64);
            _local_8._Str_24517();
        ...
        private function _Str_25371(k:IWindow):void
        {
            ...
            else
            {
                if (_local_2.tag != null)
                {
                    ...
                    {
                        this._navigator.mainViewCtrl.startSearch(Tabs.TAB_SEARCH, Tabs.SEARCHTYPE_TAG_SEARCH, _local_2.tag);
                    }
                }
                else
                {
