package com.sulake.habbo.window.widgets
{
    ...
    public class IlluminaInputWidget implements IIlluminaInputWidget
    {
        ...
        private static const multilinePropertyKey:String = (ILLUMINA_INPUT + ":multiline");
        private static const maxCharsPropertyKey:String = (ILLUMINA_INPUT + ":max_chars");
        ...
        private static const _Str_13245:PropertyStruct = new PropertyStruct(multilinePropertyKey, false, PropertyStruct.BOOLEAN);
        private static const _Str_14030:PropertyStruct = new PropertyStruct(maxCharsPropertyKey, 0, PropertyStruct.INT);
