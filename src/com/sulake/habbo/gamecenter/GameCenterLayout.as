package com.sulake.habbo.gamecenter
{
    ...
    public class GameCenterLayout implements IDisposable, IAvatarImageListener, IGameRewardListener 
    {
        ...
        private function updateLayout(k:Boolean):void
        {
            ...
            this._gameCenterView.send(new GetGameStatusMessageComposer(this._selectedGame));
        ...
        private function onFriendLeaderboard(k:IMessageEvent):void
        {
            ...
            var _local_2:WeeklyCompetitiveFriendsLeaderboardEvent = (k as WeeklyCompetitiveFriendsLeaderboardEvent);
...
_local_4 = _local_5.getCroppedImage(AvatarSetType.HEAD);
        ...
        private function onAccountGameStatus(k:IMessageEvent):void
        {
