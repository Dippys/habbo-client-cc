package com.sulake.habbo.friendbar.landingview.widget
{
    ...
    public class ExpiringCatalogPageWidget implements ILandingViewWidget, ISettingsAwareWidget 
    {
        ...
        private var _teaserImage:String;
        private var _lastRequestTime:Date;

        public function ExpiringCatalogPageWidget(k:HabboLandingView)
        {
            this._landingView = k;
        }
        ...
        private function getText(k:String, _arg_2:String, _arg_3:String):String
        {
            var _local_4:String = (((k + ((this._Str_24631) ? "" : ("." + _arg_2))) + ".") + _arg_3);
            return ("${" + _local_4) + "}";
        }

        private function get _Str_24631():Boolean
        {
            return false;
        }
        ...
        private function onCatalogPage(k:IMessageEvent):void
        {
            ...
            this._teaserImage = _local_2.image;
            this.refreshContent();
        }
