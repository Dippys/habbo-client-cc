package com.sulake.habbo.friendbar.view.tabs
{
    ...
    public class NewFriendRequestTab extends NewFriendEntityTab 
    {
        ...
        private static var _Str_4254:NewFriendRequestTab;
        ...
        public static function _Str_2363(k:IFriendRequest):NewFriendRequestTab
        {
            var _local_3:IBitmapWrapperWindow;
            var _local_2:NewFriendRequestTab = ((_Str_4254) ? _Str_4254 : new (NewFriendRequestTab)());
        ...
        private function _Str_17362():IWindowContainer
        {
            ...
            var k:IWindowContainer = (_Str_3684.buildFromXML((ASSETS.getAssetByName(FRIEND_REQUEST_TAB_XML).content as XML)) as IWindowContainer);
            ...
            _local_7 = (ASSETS.getAssetByName("plus_friend_icon_png") as BitmapDataAsset);
            if (_local_7)
            {
        ...
        public function avatarImageReady(k:FriendRequest, _arg_2:BitmapData):void
        {
            ...
            if (!disposed)
            {
                if (friend)
                {
                    ...
                    {
                        _local_3 = (window.findChildByName(CANVAS) as IBitmapWrapperWindow);
                        if (_local_3)
                        {
